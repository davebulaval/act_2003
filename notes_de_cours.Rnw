...
%% Graphe modèle quadratique
<<eval = TRUE, echo=FALSE, fig=TRUE, height=6,width=7.5>>=
# Les donnees simulees
beta <- 0.05
n <- 100
...
%% Graphe modèle linéaire simple
<<eval = TRUE, echo=FALSE, fig=TRUE, height=4,width=5>>=
# Le modele
resul <- lm(Age ~ Fare, data)
...
<<eval = TRUE, echo=FALSE, fig=TRUE, height=5,width=6.5>>=
...
<<eval = TRUE, echo=FALSE, fig=TRUE, height=3,width=4>>=
myfun <- function(xvar) {
     1*xvar + 5
}
...
<<eval = TRUE, echo=FALSE, fig=TRUE, height=3,width=5>>=
# Ajout graphe
...
<<eval = TRUE, echo=FALSE, fig=TRUE, height=3.5,width=4>>=
x <- runif(15, 0, 5)
y <- runif(15, -2, 4) 
